...
def read_exporter() -> ExporterFactory:
    """Constructs an exporter factory based on the users preference."""
...
def main(factory_exporter: ExporterFactory) -> None:
    ...
    video_exporter = factory_exporter.get_video_exporter()
    audio_exporter = factory_exporter.get_audio_exporter()
    ...
    # do the export
    folder = pathlib.Path("davi/videos")
    video_exporter.do_export(folder)
    audio_exporter.do_export(folder)


if __name__ == '__main__':
    factory_exporter = read_exporter()
    main(factory_exporter)